...
const NavBar = () => {
    ...
    const loggedInMenu = (
        <StyledCol nav="true" xs={6} sm={6} md={{ span: 4, order: 'last' }} lg={3}>
            <StyledDropdown title={<Avatar src={currentUser?.profile_image} height={40} />} id="basic-nav-dropdown">
                <StyledSignedInMsg> Signed in as <br /> <strong>{currentUser?.username}</strong></StyledSignedInMsg>
                <NavDropdown.Divider />
